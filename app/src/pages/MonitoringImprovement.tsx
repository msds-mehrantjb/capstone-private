  ...
  const handleOpenAddEvidence = async (autoFill = false) => {
    ...
    setMessages((prev) => [
      ...prev,
      {
        role: "assistant",
        content:
          "Please wait, while system is using RAG over ISO 27001:2022 controls and Qwen3 14B reasoning to prepare evidence fields for the selected host.",
      },
    ]);
    scrollChatToBottom();
  ...
  const handleRecommendForSelectedRow = async () => {
    ...
    setMessages((prev) => [
      ...prev,
      {
        role: "assistant",
        content:
        `Please wait, while system is using RAG over ISO 27001:2022 controls and Qwen3 14B reasoning to generate recommended action for selected row ${selectedControl.CVE}.`,
      },
    ]);
